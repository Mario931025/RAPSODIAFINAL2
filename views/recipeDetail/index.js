...
function RecipeDetail({navigation, route: {params}}) {
    ...
    const addIngredients = async () => {
        ...
        params.recipe.ingredients.map(ingredient => {
            const multipliedIngredient = setQuantity(ingredient.quantity);
            ingredientList.push({name: ingredient.name, quantity: multipliedIngredient});

            console.log('aaaaver si', ingredientList);
        })
        ...
        await firestore().collection('users').doc(user.uid).set({
            ingredients: {
                ...userIngredients,
                [params.recipe.uid] : ingredientList
            }
    }, {merge: true})
    }
    ...
    <>
        ...
        <ScrollView style={styles.scroll}>
            ...
            <View style={styles.ingredientsTitleView}>
                ...
                <TouchableOpacity style={styles.superIcon} onPress={addIngredients}>
            ...
            <View style={styles.buttonView}>
                <TouchableOpacity style={styles.button} onPress={() => navigation.navigate({name: 'Steps', params})}>
