            ...
            {/* <DrawerItemList {...props} /> */}
                ...
                <ImageBackground source={MenuBack} style={styles.image}>
                    ...
                    <View style={styles.menuItemView}>
                        ...
                        <Text style={styles.menuItem} onPress={() => props.navigation.navigate('Calendar')}>Planificador semanal</Text>
                    </View>
                    <View style={styles.menuItemView}>
                    ...
                    <View style={styles.menuItemView}>
                        ...
                        <Text style={styles.menuItem} onPress={() => props.navigation.navigate('Lista')}>Lista de súper</Text>
                    </View>
                    <View style={styles.menuItemView}>
